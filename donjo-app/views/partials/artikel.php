		...
		";
			...
			if($single_artikel['gambar']!=''){
				if(is_file(LOKASI_FOTO_ARTIKEL."kecil_".$single_artikel['gambar'])) {
					...
					<img src=\"".AmbilFotoArtikel($single_artikel['gambar'],'kecil')."\" /></div>";
				}
			}
		echo "
		<div class=\"teks\">".$single_artikel["isi"]."</div>";
			...
			if($single_artikel['gambar1']!=''){
				if(is_file(LOKASI_FOTO_ARTIKEL."kecil_".$single_artikel['gambar1'])) {
					echo "<div class=\"sampul2\">
					<img src=\"".AmbilFotoArtikel($single_artikel['gambar1'],'kecil')."\" /></div>";
				}
			}
			if($single_artikel['gambar2']!=''){
				if(is_file(LOKASI_FOTO_ARTIKEL."kecil_".$single_artikel['gambar2'])) {
					echo "<div class=\"sampul2\">
					<img src=\"".AmbilFotoArtikel($single_artikel['gambar2'],'kecil')."\" /></div>";
				}
			}
			if($single_artikel['gambar3']!=''){
				if(is_file(LOKASI_FOTO_ARTIKEL."kecil_".$single_artikel['gambar3'])) {
					echo "<div class=\"sampul2\">
					<img src=\"".AmbilFotoArtikel($single_artikel['gambar3'],'kecil')."\" /></div>";
				}
			}
		echo "
		<div class=\"form-group\" style=\"clear:both;\">
			<ul id=\"pageshare\" title=\"bagikan ke teman anda\" class=\"pagination\">
				<li class=\"sbutton\" id=\"fb\"><a name=\"fb_share\" target=\"_blank\" href=\"http://www.facebook.com/sharer.php?u=".site_url()."artikel/".$single_artikel["id"]."/".url_title($single_artikel["judul"])."\"><i class=\"fa fa-facebook-square\"></i>&nbsp;Share</a></li>
				<li class=\"sbutton\" id=\"rt\"><a href=\"http://twitter.com/share\" target=\"_blank\" class=\"twitter-share-button\"><i class=\"fa fa-twitter\"></i>&nbsp;Tweet</a></li>
				<li class=\"sbutton\" id=\"gpshare\"><a target=\"_blank\" href=\"https://plus.google.com/share?url=".site_url()."artikel/".$single_artikel["id"]."/".url_title($single_artikel["judul"])."&hl=id"."\"><i class=\"fa fa-google-plus\" style=\"color:red\"></i>&nbsp;Bagikan</a></li>
			</ul>
			<!--
